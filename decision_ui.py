...
def build_decision_card(
    ...
    **_: Any,
    ...
    # Synthesise components_a/b from metric_breakdown when not explicitly provided
    # so comparison_metrics() returns items with a_value/b_value/team_a/team_b fields.
